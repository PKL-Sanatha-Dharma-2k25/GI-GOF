...
<div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
    <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
        <div class="grow">
            <h5 class="text-16">Dashboard SuperAdmin</h5>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
                <div class="flex flex-col">
                    <label for="select" class="mb-1 text-sm font-medium text-gray-700">Select</label>
                    <select class="form-select border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400">
                ...
                <div class="flex flex-col">
                    <label for="select2" class="mb-1 text-sm font-medium text-gray-700">Select 2</label>
                    <select class="select2 border border-gray-300 rounded px-3 py-2 w-full bg-white text-sm">
                        <option selected>Select</option>
                        <option value="1">One</option>
                        <option value="2">Two</option>
                        <option value="3">Three</option>
    ...
    <div class="w-screen lg:w-[55rem] bg-white shadow rounded-md flex flex-col h-full">
        ...
        <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
            <div class="grid grid-cols-1 gap-5 md:grid-cols-1 xl:grid-cols-1 mx-5 ">
                <div class="mb-3">
                    <label for="inputText" class="inline-block mb-2 text-base font-medium">Text <span class="text-red-500">*</span></label>
                    <input type="text" id="inputText" class="form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400" required>
                </div>
                <div>
                    <label for="textArea" class="inline-block mb-2 text-base font-medium">Example Textarea</label>
                    <textarea class="form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400" id="textArea" rows="3"></textarea>
                </div>
            </div>
        </div>
