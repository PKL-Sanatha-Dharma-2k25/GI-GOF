    ...
    <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
        ...
        <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
            ...
            <li class="text-slate-700">
                <a href="showAllApplication" class="text-slate-400">All Application</a>
            </li>
        </ul>
    </div>
    <div class="card mt-3">
        <div class="card-body">
            <div class="grid grid-cols-1 gap-x-5 md:grid-cols-4 xl:grid-cols-5 mb-5">
                <div class="md:col-span-2">
                    <div>
                        ...
                        <p class="text-xs text-gray-400 mt-1">*Click on <strong>No Application</strong> to see
            ...
            <div class="overflow-x-auto">
                <table class="display stripe group w-full text-center table-auto min-w-max" style="width:100%"
                    id="myTable">
                    <thead>
                        <tr>
