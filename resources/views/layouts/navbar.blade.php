<div id="cartSidePenal" drawer-end
  ...
  <div>
      ...
      <div class="flex flex-col gap-4">
        <div class="flex gap-2 product">
          <div class="flex items-center justify-center w-12 h-12 rounded-md bg-slate-100 shrink-0">
            <img src="{{ asset('public/assets/images/product/img-01.png') }}" alt="" class="h-8">
          </div>
        ...
        <div class="flex gap-2 product">
          <div class="flex items-center justify-center w-12 h-12 rounded-md bg-slate-100 shrink-0">
            <img src="{{ asset('public/assets/images/product/img-03.png') }}" alt="" class="h-8">
          </div>
          <div class="overflow-hidden grow">
            <div class="ltr:float-right rtl:float-left">
              <button
        ...
        <div class="flex gap-2 product">
          <div class="flex items-center justify-center w-12 h-12 rounded-md bg-slate-100 shrink-0">
            <img src="{{ asset('public/assets/images/product/img-09.png') }}" alt="" class="h-8">
          </div>
          <div class="overflow-hidden grow">
            <div class="ltr:float-right rtl:float-left">
              <button
    ...
    <div class="p-4 border-t border-slate-200">
      ...
      <div class="flex items-center justify-between gap-3">
        <a href="apps-ecommerce-product-grid.php"
